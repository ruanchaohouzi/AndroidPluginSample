package com.ruanchao.app2.hook;
...
public class HookAmsUtil {
    ...
    private static final String TAG  = HookAmsUtil.class.getSimpleName();
    ...
    public static final String PLUGIN_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()
            + File.separator + "plugin-hook-app2-debug.apk";

    public HookAmsUtil(Context context){
        mContext = context;
    }
...
//            Instrumentation mInstrumentationValue = (Instrumentation) mInstrumentationField.get(currentActivityThreadValue);
            ...
            HookInstrumentationProxy instrumentationProxy = new HookInstrumentationProxy(mContext,
